...
Future<ModelCommonResponse> userDocumentVerifyRepo({
  required mapData,
  required fieldName1,
  required File file1,
  required fieldName2,
  ...
  try {
    ...
    var request = http.MultipartRequest('POST', Uri.parse(ApiUrls.userDocumentVerify));
    ...
    if(file2.path != "") request.files.add(await multipartFile(fieldName2, file2));
