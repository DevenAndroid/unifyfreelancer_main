                ...
                child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        model.value.data!.projectDuration
                                            .toString(),
                                        style: TextStyle(
                                            fontSize: 14.sp,
                                            fontWeight: FontWeight.w600,
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        model.value.data!.experienceLevel
                                            .toString(),
                                        style: TextStyle(
                                            fontSize: 14.sp,
                                            fontWeight: FontWeight.w600,
                          ...
                          children: List.generate(
                              model.value.data!.skills!.length,
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () {},
                                    child: Text(
                                      model.value.data!.skills![index].name
                                          .toString(),
                                      style: TextStyle(
                        ...
                        Text(
                          "Client's budget: \$${model.value.data!.price.toString().isEmpty ? " -": model.value.data!.price.toString()} USD",
                          style: TextStyle(
                              fontSize: 13.sp,
                              color: const Color(0xff180D31),
                              fontWeight: FontWeight.w300),
                        ...
                        TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: '\$',
                              focusColor: AppTheme.primaryColor,
                              suffixIcon: _receiveController.text.length ==
                                  0
                                  ? Align(
                                  alignment: Alignment.centerRight,
                                  child: Padding(
