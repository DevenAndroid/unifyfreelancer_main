                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          child: profileController.model.value.data!.isClient ==
                                      true &&
                                  profileController
                        ...
                        Container(
                          ...
                          child: editContact == true
                              ? Form(
                                  key: _formKey1,
                                  child: controller
                                          .statusOfTimezone.value.isSuccess
                                      ? Column(
                                          crossAxisAlignment:
                                              CrossAxisAlignment.start,
                                          children: [
                                                                        ...
                                                                        return Obx(
                                                                          ...
                                                                          return InkWell(
                                                                            onTap:
                                                                                () {
                                                                              setState(() {
                                                                                countryController.text = searchList1[index].toString();
                                                                              });
                                      ...
                                      : controller
                                              .statusOfTimezone.value.isError
                                          ? SizedBox(
