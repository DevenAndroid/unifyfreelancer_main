...
class _SearchJobScreenState extends State<SearchJobScreen> {
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      if(controller.status.value.isError)
                        CommonErrorWidget(errorText: controller.model.value.message.toString(), onTap: () { controller.getData(); },),
  ...
  jobsList() {
    ...
    return controller.model.value.data!.length == 0
        ? Center(
                ...
                return InkWell(
                  onTap: () {
                    Get.toNamed(MyRouter.jobDetailsScreen, arguments: [
                      controller.model.value.data![index].id,
                    ]);
