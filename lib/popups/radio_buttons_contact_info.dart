...
class RadioButtonsContactInfo extends StatefulWidget {
  ...
  @override
  State<RadioButtonsContactInfo> createState() =>
      _RadioButtonsContactInfoState();
}
...
class _RadioButtonsContactInfoState extends State<RadioButtonsContactInfo> {
  ...
  Widget build(BuildContext context) {
    return Dialog(
        ...
        child: Obx(() {
          return controller.statusOfReason.value.isSuccess
              ? Padding(
                            ...
                            child: CustomOutlineButton(
                              onPressed: () {
                                if (reason == "") {
                                  ...
                                  closeAccountRepo(
                                          reason_id: reason, context: context)
                                      .then((value) {
